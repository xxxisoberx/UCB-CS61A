...
def subseqs(s):
    ...
    if len(s) == 0:
        ...
        sub_without_first = subseqs(s[1:])
        return sub_without_first + insert_into_all(s[0], sub_without_first)
...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    cur_point, total_point = 0, 0
    def student(key, value):
        nonlocal cur_point, total_point
        cur_point += value
        total_point += class_assignments[key]
        return cur_point / total_point
    return student
...
def make_advanced_counter_maker():
    ...
    def make_counter():
        per_count = 0
        def personal_counter(str):
            nonlocal glo_count, per_count
            "*** YOUR CODE HERE ***"
